    ...
    <div class="col-md-6">
      <div class="panel panel-primary">
        <div class="panel-heading">
          <span class="glyphicon glyphicon-list" />Sortable Lists
          ...
          <div class="pull-right action-buttons">
            <div class="btn-group pull-right">
              ...
              <ul class="dropdown-menu slidedown">
                ...
                <li>
                  <a href="http://www.jquery2dotnet.com"><span
                      class="glyphicon glyphicon-flag" />Flag</a>
                </li>
              </ul>
            </div>
          </div>
          ...
          <ul class="list-group">
            <li class="list-group-item">
              ...
              <div class="pull-right action-buttons">
                ...
                <a href="http://www.jquery2dotnet.com" class="flag"><span
                    class="glyphicon glyphicon-flag" /></a>
              </div>
            </li>
            <li class="list-group-item">
              <div class="checkbox">
                <input type="checkbox" id="checkbox2" />
                <label for="checkbox2"> List group item heading 1 </label>
              </div>
              <div class="pull-right action-buttons">
                <a href="http://www.jquery2dotnet.com"><span
                    class="glyphicon glyphicon-pencil" /></a>
            ...
            <li class="list-group-item">
              <div class="checkbox">
                ...
                <label for="checkbox3"> List group item heading 2 </label>
              </div>
              <div class="pull-right action-buttons">
                <a href="http://www.jquery2dotnet.com"><span
                    class="glyphicon glyphicon-pencil" /></a>
            ...
            <li class="list-group-item">
              <div class="checkbox">
                ...
                <label for="checkbox4"> List group item heading 3 </label>
              </div>
              <div class="pull-right action-buttons">
                <a href="http://www.jquery2dotnet.com"><span
                    class="glyphicon glyphicon-pencil" /></a>
            ...
            <li class="list-group-item">
              <div class="checkbox">
                ...
                <label for="checkbox5"> List group item heading 4 </label>
              </div>
              <div class="pull-right action-buttons">
                <a href="http://www.jquery2dotnet.com"><span
                    class="glyphicon glyphicon-pencil" /></a>
